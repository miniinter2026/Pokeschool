        ...
        <table id="tabelaAlunos">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <button class="btn btn-edit" onclick="abrirModalEdit('<%= a.getRa() %>', '<%= a.getNomeCompleto() %>', '<%= a.getEmail() %>', '<%= a.getSala() %>')">Editar</button>
...
<div id="modal-aluno" class="modal">
    <div class="modal-content">
        ...
        <form action="adminAluno" method="post" id="form-aluno">
...
<div id="modal-delete" class="modal">
    <div class="modal-content">
        ...
        <form action="adminAluno" method="post">
