...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/Styles/verificar-token.css" />
</head>
<body>
...
<div class="container">
  ...
  <form action="${pageContext.request.contextPath}/recuperar-senha" method="POST">
    ...
    <input type="text" name="token" maxlength="6" placeholder="Digite o token recebido" required>
