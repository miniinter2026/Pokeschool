        ...
        <table id="tabelaProfessores">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <button class="btn btn-edit" onclick="abrirModalEdit('<%= p.getId() %>', '<%= p.getNomeCompleto() %>', '<%= p.getNomeUsuario() %>', '<%= p.getEmail() %>', '<%= p.getIdDisciplina() %>')">Editar</button>
                ...
                %>
                <tr>
                    <td colspan="6" class="no-data">Nenhum professor cadastrado.</td>
                </tr>
                <%
                    }
                %>
...
<div id="modal-professor" class="modal">
    <div class="modal-content">
        ...
        <form action="adminProfessores" method="post" id="form-professor">
...
<script>
    ...
    function abrirModalEdit(id, nome, usuario, email, disciplina) {
    ...
    function buscarProfessor() {
        ...
        for (var i = 1; i < tr.length; i++) {
            ...
            if (tdNome) {
                ...
                tr[i].style.display = textNome.toUpperCase().indexOf(filter) > -1 ? '' : 'none';
            }
        }
    }
